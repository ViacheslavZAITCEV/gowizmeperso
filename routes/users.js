...
var sorties = require('../models/sorties');
...
/* -----------------  */
/* GET users/getAllBD   */
router.get('/getAllBD', async function(req, res, next) {

  console.log('Route getAllBD');
  var response = {response : false};
  
  try{
    reponse.users = users.find();
  }catch(e){
    console.log(e);
    reponse.error = e;
  }
  ...
  try{
    reponse.friendRequest = friendRequest.find();
  }catch(e){
    console.log(e);
    reponse.error = e;
  }
...
/* -----------------  */
/* GET /copyBD   */
router.get('/copyBD', function(req, res, next) {
  console.log('Route copyBD...');
  ...
  const server = http.createServer( async (req, res) => {
    var events = await fetch('http://localhost:3000/users/getAllBD')
    console.log('Route copyBD', events);
...
function updateUser(userUpdated, data){
  ...
  if (data.preferences != null){
    userUpdated.preferences = data.preferences.json();
  }
